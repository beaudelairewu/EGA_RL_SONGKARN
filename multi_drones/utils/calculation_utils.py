...
def normalize_action(action):
    action[0] = normalize(action[0], (-1,1), (-3.14, 3.14)) #motor pwm
    action[1] = normalize(action[1], (-1,1), (-3.14, 3.14)) #motor pwm
    action[2] = normalize(action[2], (-1,1), (-3.14, 3.14)) #motor pwm
