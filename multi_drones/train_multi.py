...
def config_new_train():
    ...
    envs = SubprocVecEnv([lambda: EgaEnv(0, formatted_datetime), lambda: EgaEnv(1, formatted_datetime), lambda: EgaEnv(2, formatted_datetime), lambda: EgaEnv(3, formatted_datetime), lambda: EgaEnv(4, formatted_datetime), lambda: EgaEnv(5, formatted_datetime), lambda: EgaEnv(6, formatted_datetime), lambda: EgaEnv(7, formatted_datetime),lambda: EgaEnv(8, formatted_datetime), lambda: EgaEnv(9, formatted_datetime), lambda: EgaEnv(10, formatted_datetime), lambda: EgaEnv(11, formatted_datetime)])
