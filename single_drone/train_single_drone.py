...
model = PPO("MultiInputPolicy", EgaEnv(dir), verbose=1, n_steps=2048, batch_size=64, ent_coef=0.01)#, tensorboard_log="/Users/noppa/Documents/AI_logs/tensorboard") #tensorboard_log="ppo_cur1_tensorboard"
