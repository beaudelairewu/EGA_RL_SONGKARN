...
checkpoint_callback = CheckpointCallback(
  save_freq=5000,
  save_path="/Users/EGA/Documents/GitHub/AI_logs/checkpoints",
...
model = PPO("MultiInputPolicy", EgaEnv(log_dir), verbose=1, n_steps=2048, batch_size=64, tensorboard_log="/Users/EGA/Documents/GitHub/AI_logs/tensorboard") #tensorboard_log="ppo_cur1_tensorboard"
